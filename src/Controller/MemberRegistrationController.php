...
Class MemberRegistrationController  extends AppController
{
	...
	public function index()
	{
		...
		if($this->request->is("post"))
		{
			...
			if(isset($this->request->data['gym']) && $this->MemberRegistration->GymMember->save($member))
			{
			...
			}elseif(!isset($this->request->data['gym'])){
				$this->Flash->error(__('Please select the gym'));
			}else{
				if($member->errors())
				{
