...
{
	return $week=array("Monday"=>__('Monday'),'Tuesday'=>__('Tuesday'),'Wednesday'=>__('Wednesday'),'Thursday'=>__('Thursday'),'Friday'=>__('Friday'),'Saturday'=>__('Saturday'),'Sunday'=>__('Sunday'));
}
...
public function get_total_group_members($gid)
{
	...
	$data = $mem_table->find("all")->where(["role_name"=>"member"])->select(["id"]);
	return $data->count();
}
	...
	function isMemberInThisReservation($rid, $mid){
