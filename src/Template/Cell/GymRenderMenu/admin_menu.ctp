...
<?php } ?>
     ...
     <!-- <form action="#" method="get" class="sidebar-form">
          ...
          <!-- <li class="header">MAIN NAVIGATION</li> -->
            <li class= "treeview <?php echo ($this->request->controller == "Dashboard" && $this->request->action !== "map") ? "active" : "";?>">
			...
			<li class="treeview <?php echo ($this->request->controller == "Dashboard" && $this->request->action === "map") ? "active" : "";?>">
        <a href="<?php echo $this->Gym->createurl("Dashboard","map");?>">
          <i class="fa fa-map"></i> <span><?php echo __("Map");?></span></i>
        </a>
			</li>
          </ul>
