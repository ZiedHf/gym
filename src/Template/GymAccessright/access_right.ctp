...
<form name="student_form" action="" method="post" class="form-horizontal" id="access_right_form">
		...
		<div class="row">
			<div class="col-md-2 col-sm-3 col-xs-5">
				<span class="menu-label">
					<?php echo __("Map");?></span>
			</div>
			<div class="col-md-2 col-sm-3 col-xs-2">
				<div class="checkbox">
					<label>
						<input type="checkbox" <?php echo ($member["map"])?"checked":"";?> value="1" name="member_map" readonly="">
					</label>
				</div>
			</div>
			<div class="col-md-2 col-sm-3 col-xs-2">
				<div class="checkbox">
					<label>
						<input type="checkbox" value="1" <?php echo ($staff_member["map"])?"checked":"";?> name="staff_member_map" readonly="">
					</label>
				</div>
			</div>
			<div class="col-md-2 col-sm-3 col-xs-2">
				<div class="checkbox">
					<label>
						<input type="checkbox" value="1" <?php echo ($accountant["map"])?"checked":"";?> name="accountant_map" readonly="">
					</label>
				</div>
			</div>
