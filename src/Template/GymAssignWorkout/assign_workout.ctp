...
$activities = array("Sets" => __('Sets'), "Reps" => __('Reps'), "KG" => __('Kg'), "Rest Time" => __('Rest Time'));
$week = array("Monday"=>__('Monday'),'Tuesday'=>__('Tuesday'),'Wednesday'=>__('Wednesday'),'Thursday'=>__('Thursday'),'Friday'=>__('Friday'),'Saturday'=>__('Saturday'),'Sunday'=>__('Sunday'));
?>
...
function add_day(day,id)
 {
	...
	string = '<span id="'+id+'">'+week[day]+'</span>, ';
...
function add_activity(activity,id)
{
	...
	string += '<span id="sets_'+id+'"> <?= $activities['Sets'] ?> '+sets+', </span>';
	string += '<span id="reps_'+id+'"> <?= $activities['Reps'] ?> '+reps+', </span>';
	string += '<span id="kg_'+id+'"> <?= $activities['KG'] ?> '+kg+', </span>';
	string += '<span id="time_'+id+'"> <?= $activities['Rest Time'] ?> '+time+', </span></p>';
...
$("body").on("change",".activity_check",function(){
		 ...
		 if($(this).is(":checked"))
		{
			id = $(this).attr('id');
			string = '';
			var sets = "<?php echo $activities['Sets'] ?>";
			var reps = "<?php echo $activities['Reps'] ?>";
			var kg = "<?php echo $activities['KG'] ?>";
			var restTime = "<?php echo $activities['Rest Time'] ?>";
			...
			string += '<div class="achilactiveadd"><span class="label">.'+restTime+' </span><input type="text" name = "time_' + id + '" id = "time_' + id + '" placeholder="Min"></div>';
