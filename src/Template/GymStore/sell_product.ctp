...
$(document).ready(function(){
	$(".sell-date").datepicker({format:"dd-mm-yyyy"});
	<?php
	if($edit){?>
...
<section class="content">
	...
	<div class="col-md-12 box box-default">
		...
		<div class="col-md-6">
			<input type="text" name="sell_date" class="sell-date form-control validate[required]" value="<?php echo ($edit)?date("d-m-Y",strtotime($data["sell_date"])) : "";?>">
		</div>
		</div>
		<div class='form-group'>
