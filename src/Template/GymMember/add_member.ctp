...
<section class="content">
	...
	<div class="col-md-12 box box-default">
		...
		<?php
			...
			echo '<div class="col-md-6">';
			echo $this->Form->input("",["label"=>false,"name"=>"birth_date","class"=>"form-control dob validate[required] datepick","value"=>(($edit) ? date($this->Gym->getSettings("date_format"),strtotime($data['birth_date'])) : '')]);
			echo "</div>";
			echo "</div>";
/*
			echo "<div class='form-group'>";
...
*/
			...
			echo '<div class="col-md-6">';
			echo @$this->Form->select("selected_membership",$membership,["default"=>1,"class"=>"form-control validate[required] membership_id", "disabled" => true]);
			echo "</div>";
			//echo '<div class="col-md-2">';
			...
			echo '<div class="col-md-6">';
			echo $this->Form->select("assign_class",$classes,["default"=>($edit)?$member_class:"","class"=>"class_list form-control","id"=>"class_list","multiple"=>"multiple"]);
			echo "</div>";
			echo '<div class="col-md-2">';
			...
			echo '<div class="col-md-2">';
			echo $this->Form->input("",["label"=>false,"name"=>"membership_valid_from","class"=>"form-control validate[required] mem_valid_from","value"=>(($edit && $data['membership_valid_from']!="")? date($this->Gym->getSettings("date_format"),strtotime($data['trial_end_date'])) :'')]);
			echo "</div>";
			echo '<div class="col-md-1 no-padding text-center">';
			echo "To";
			echo "</div>";
			echo '<div class="col-md-2">';
			echo $this->Form->input("",["label"=>false,"name"=>"membership_valid_to","class"=>"form-control validate[required] valid_to","value"=>(($edit && $data['membership_valid_to']!="")? date($this->Gym->getSettings("date_format"),strtotime($data['trial_end_date'])) :''),"readonly"=>true]);
			echo "</div>";
			echo "</div>";
			...
			echo '<div class="col-md-6">';
			echo $this->Form->input("",["label"=>false,"name"=>"first_pay_date","class"=>"form-control datepick","value"=>(($edit)? date($this->Gym->getSettings("date_format"),strtotime($data['trial_end_date'])) :'')]);
			echo "</div>";
			echo "</div>";
			echo "</fieldset>";
