...
<section class="content">
	...
	<div class="col-md-12 box box-default">
		...
		<div class="form-group">
			...
			<div class="col-sm-3">
				<?php echo $this->Form->input("",["label"=>false,"name"=>"membership_valid_from","class"=>"form-control validate[required] mem_valid_from","value"=>($edit)?date("d-m-Y",strtotime($data["start_date"])):""]); ?>
			</div>
			<div class="col-sm-1 text-center">	<?php echo __("To");?>			</div>
			<div class="col-sm-4">
				<?php echo $this->Form->input("",["label"=>false,"name"=>"membership_valid_to","class"=>"form-control validate[required] valid_to","value"=>(($edit)?date("d-m-Y",strtotime($data['end_date'])):''),"readonly"=>true]);
				?>
			</div>
		</div>
